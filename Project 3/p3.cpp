...
//////
            ...
            while (1) {
                ...
                /*Dll<string> newList1 = Dll<string>(list);
                cout << "Copy Constructor creates this list:" << endl;
                cout<<newList1<<endl;

                Dll<string> newList2 = list;
                cout << "= operator creates this list:" << endl;
                cout<<newList1<<endl;*/
            }
        }
        else if (ch == 's') {
